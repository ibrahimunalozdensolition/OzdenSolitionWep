      ...
      <div className="bg-gradient-to-br from-slate-900/50 via-purple-900/30 to-blue-900/50">
        ...
        <main className="relative z-10 px-4 sm:px-6 lg:px-8 pb-20">
          ...
          <div className="text-center space-y-8 max-w-4xl mx-auto py-16">
            <h2 className="text-3xl sm:text-5xl font-bold bg-gradient-to-r from-red-400 via-orange-400 to-red-400 bg-clip-text text-transparent">
              Güvenliğinizi Sağlamlaştırın
            </h2>
            <button onClick={() => setShowWhatsAppModal(true)} className="px-10 py-5 bg-gradient-to-r from-red-600 to-orange-600 rounded-full text-white font-bold text-lg transition-all duration-300 hover:from-red-700 hover:to-orange-700 hover:scale-105">
