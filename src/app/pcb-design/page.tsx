      ...
      <div className="bg-gradient-to-br from-slate-900/50 via-purple-900/30 to-blue-900/50">
        ...
        <main className="relative z-10 px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-center min-h-screen text-center space-y-8 max-w-4xl mx-auto">
            <h1 className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-yellow-400 via-orange-400 to-yellow-400 bg-clip-text text-transparent">
              PCB Tasarım Hizmetleri
            </h1>
            <p className="text-xl text-slate-300">
              Detaylı bilgi için Elektronik Kart Tasarım sayfamızı ziyaret edin
            </p>
            <Link 
              href="/electronic-design" 
              className="px-8 py-4 bg-gradient-to-r from-yellow-600 to-orange-600 rounded-full text-white font-semibold text-lg transition-all duration-300 hover:from-yellow-700 hover:to-orange-700 hover:scale-105"
            >
              Elektronik Tasarım Sayfasına Git
            </Link>
          </div>
        </main>
      </div>
